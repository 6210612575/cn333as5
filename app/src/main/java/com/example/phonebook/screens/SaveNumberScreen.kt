...
@Composable
fun SaveNumberScreen(viewModel: MainViewModel) {
    ...
    val CheckTag = rememberSaveable { mutableStateOf(false) }
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ContentTextField(
            ...
            onTextChange = { newContent ->
                onNoteChange.invoke(note.copy(number = newContent))
            }
        )
